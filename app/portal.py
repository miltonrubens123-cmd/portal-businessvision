...
def aplicar_estilo_login():
    st.markdown(
        ...
        .stApp {
            background:
                radial-gradient(circle at top right, rgba(0, 153, 255, 0.14) 0%, transparent 24%),
                radial-gradient(circle at bottom left, rgba(0, 200, 255, 0.10) 0%, transparent 26%),
...
def aplicar_estilo_global():
    st.markdown(
        ...
        .stApp {
            background:
                radial-gradient(circle at top right, rgba(0, 153, 255, 0.10) 0%, transparent 24%),
                radial-gradient(circle at bottom left, rgba(0, 200, 255, 0.08) 0%, transparent 26%),
                linear-gradient(135deg, #061C33 0%, #0B3A63 100%);
        }

        section[data-testid="stSidebar"] {
            background: linear-gradient(180deg, rgba(4,18,34,0.96) 0%, rgba(8,42,74,0.96) 100%);
